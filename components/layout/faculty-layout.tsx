...
export function FacultyLayout({ children, userName = "Dr. Priya Nair", userAvatar }: FacultyLayoutProps) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuItem asChild>
                <Link href="/faculty/profile" className="flex items-center gap-2 cursor-pointer">
